...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-12">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {{-- Canales de contacto --}}
        <div class="space-y-4">
            <a href="https://wa.me/{{ $ajustes->whatsappNumero() }}" target="_blank" rel="noopener noreferrer"
               class="flex items-center gap-4 p-5 bg-[#25D366]/10 border border-[#25D366]/30 rounded-2xl hover:bg-[#25D366]/20 transition-all group">
                ...
                <div>
                    ...
                    <div class="text-xs text-slate-500">{{ $ajustes->get('telefono') }} · Lunes a Sábado 8:00 – 20:00</div>
                </div>
            </a>
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm"
             x-data="{ sent: false, name: '', email: '', msg: '',
                submitContact() {
                    ...
                    window.open('https://wa.me/{{ $ajustes->whatsappNumero() }}?text=' + text, '_blank');
                    this.sent = true;
                }
             }">
            <div x-show="!sent">

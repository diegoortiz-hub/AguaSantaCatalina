...
<body>
    <div class="card">
        ...
        <img src="{{ asset('images/logo-blanco.png') }}" alt="Aguas Santa Catalina" class="brand-logo">
        ...
        <div class="contact-links">
            <a href="https://wa.me/{{ $ajustes->whatsappNumero() }}?text=Hola!%20Vi%20que%20el%20sitio%20est%C3%A1%20en%20mantenci%C3%B3n%20y%20necesito%20ayuda."

    ...
    <div class="relative rounded-3xl overflow-hidden bg-slate-900 text-white min-h-[360px] flex items-center shadow-xl">
        ...
        <div class="relative z-10 p-6 sm:p-12 max-w-2xl">
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                ...
                <a href="https://wa.me/{{ $ajustes->whatsappNumero() }}?text=Hola%2C+soy+una+empresa+y+quiero+información+sobre+planes+B2B"
    ...
    <div id="calculadora"
         x-data="{
            ...
            submitQuote() {
                ...
                window.open('https://wa.me/{{ $ajustes->whatsappNumero() }}?text=' + msg, '_blank');

...
<div class="max-w-7xl mx-auto px-4 py-10"
     x-data="{
        ...
        get freeFrom() { return window.TIENDA.despacho.gratis_desde; },
        get shipping() { return this.subtotal >= this.freeFrom ? 0 : window.TIENDA.despacho.estandar; },
            ...
            <div class="card p-6 sticky top-24">
                ...
                <div class="space-y-3 mb-4 pb-4 border-b border-gray-100">
                    ...
                    <div x-show="shipping > 0" class="text-xs text-gray-400 bg-blue-50 rounded-lg px-3 py-2">
                        Agrega <span x-text="`$${(freeFrom-subtotal).toLocaleString('es-CL')}`" class="font-semibold text-[#1a56c4]"></span> más para despacho gratis
                    </div>
                </div>
                ...
                <a href="https://wa.me/{{ $ajustes->whatsappNumero() }}?text=Hola!%20Quiero%20hacer%20un%20pedido" target="_blank"

    ...
    <div class="grid lg:grid-cols-4 gap-8 items-start">
        ...
        <aside class="lg:col-span-1">
            <div class="card overflow-hidden">
                ...
                {{-- Nav links --}}
                @php
                // "Mi Perfil" salió de aquí: apuntaba a la ruta mi-cuenta, que
                // devuelve esta misma lista de pedidos. No hay página de perfil
                // todavía, y un enlace que no lleva a lo que dice es peor que
                // no tenerlo.
                $navLinks = [
                ...
                if (auth()->user()->isAdmin()) {
                    array_unshift($navLinks, ['admin.dashboard', 'M9 17V7m4 10V11m4 6V9M5 21h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2z', 'Panel de administración']);
                }
                @endphp
